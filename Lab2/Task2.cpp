            ...
            if (token.token == EQ) {
                ...
                if (token.token == TEND) {
                    ...
                    if (token.token == SMCLN) {
                        ...
                        isValid = false;
                        cout << "Missed semilcolon ';' at line " + to_string(lineNumber) + " position " + to_string(position) << endl;
                    }
                }
                else {
                    isValid = false;
                    cout << "Missed 'end' at line " + to_string(lineNumber) + " position " + to_string(position) << endl;
                }
            }
            else {
                isValid = false;
                cout << "Missed equation sign '=' at line " + to_string(lineNumber) + " position " + to_string(position) << endl;
            }
        }
        else {
            isValid = false;
            cout << "Missed TBEGIN at line " + to_string(lineNumber) + " position " + to_string(position) << endl;
        }
